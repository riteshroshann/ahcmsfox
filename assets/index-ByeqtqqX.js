              ...
              <form id="change-req-form">
                <div class="form-group">
                  ...
                  <select class="form-select" id="change-target-room" name="to_room_id" required>
                    ...
                    ${w.map(b=>`<option value="${b.room_id}">${b.room_id} (${b.current_occupancy}/${b.capacity})</option>`).join("")}
                  </select>
